...
const parser = lr.LRParser.deserialize({
  ...
  maxTerm: 269,
  nodeProps: [
    [common.NodeProp.group, -26,4,46,75,76,81,86,91,143,145,148,149,151,154,156,159,161,163,165,170,172,174,176,178,179,181,189,"Statement",-24,6,13,14,15,16,17,18,19,20,21,38,39,40,98,99,101,102,105,116,118,120,123,125,128,"Expression",-7,22,23,24,25,26,28,33,"Type"],
    [common.NodeProp.openedBy, 10,"(",43,"{"],
    [common.NodeProp.closedBy, 11,")",44,"}"]
  ],
  skippedNodes: [0,1,2],
  repeatNodeCount: 27,
  ...
  specialized: [{term: 227, get: value => spec_identifier[value] || -1}],
  tokenPrec: 7012
});
